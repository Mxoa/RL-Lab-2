...
with open("config.yaml", "r") as file:
    config = yaml.safe_load(file) # config type: dict
...
print(f"Plot saved as: results_gamma_{args.discount_factor}...")
...
# Create 'data_experiments' directory if it doesn't exist
...
# Disable blocking plt.show() if display was not explicitly requested
if SHOW_PLOT:
    plt.show()
plt.close()
